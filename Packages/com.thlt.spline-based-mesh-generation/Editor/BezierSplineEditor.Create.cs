    ...
    public partial class BezierSplineEditor
    {
        ...
        private void PopulateTreeView()
        {
            ...
            _splineTreeView.bindItem = (e, id) =>
            {
                ...
                var canDrawGizmos = e.Q<Toggle>("Draw");
                if (canDrawGizmos == null)
                {
                    PrintError("No Draw Toggle found");
                    return;
                }
                canDrawGizmos.SetBinding(nameof(Toggle.value), new DataBinding
                {
                    
                    dataSourcePath = new PropertyPath(nameof(BezierSpline.CanDrawGizmos)),
                    bindingMode = BindingMode.TwoWay
                });
